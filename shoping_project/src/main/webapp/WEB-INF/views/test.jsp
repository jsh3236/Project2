...
<script src="<c:url value="resoueces/js/jquery-3.2.1.min.js" />"></script>
<script src="<c:url value="resoueces/styles/bootstrap4/popper.js" /> "></script>
<script src="<c:url value="resoueces/styles/bootstrap4/bootstrap.min.js" />"></script>
<script src="<c:url value="resoueces/plugins/Isotope/isotope.pkgd.min.js" />"></script>
<script src="<c:url value="resoueces/plugins/OwlCarousel2-2.2.1/owl.carousel.js" />"></script>
<script src="<c:url value="resoueces/plugins/easing/easing.js" />"></script>
<script src="<c:url value="resoueces/js/custom.js" />"></script>
</body>

...
<%-- 	<table style="width: 1300px;">
	...
	<!-- Slider -->
	<div class="main_slider" style="background-image:url(css_image/slider_1.jpg)">
		<div class="container fill_height">
			<div class="row align-items-center fill_height">
				<div class="col">
					<div class="main_slider_content">
						<h6>${pageContext.request.contextPath}</h6>
	...
	<div class="banner">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(css_image/mouse.jpg))">
						<div class="banner_category">
							<a href="categories.html">Mouse</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(css_image/keyboard.jpg)">
						<div class="banner_category">
							<a href="categories.html">Keyboard</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(css_image/monitor.jpg)">
						<div class="banner_category">
							<a href="categories.html">Monitor</a>
						</div>
					</div>
				</div>
			</div>

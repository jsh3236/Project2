...
<body>
					...
					<c:if test="${(st.count + (pageInfo.page-1)*10)%2 eq 1 }">
						...
						<td style="padding: 100px">
								<c:choose>
									...
									href="boardDetail.bo?boardnum=${article.boardNum}&page=${pageInfo.page}">
										<img src="<c:url value='/image/${article.boardFile}' />"
										width=200 height=200 />
								</a> <br> ${article.boardSubject}
						</td>
	...
	<sec:authorize access="hasAnyRole('ROLE_ADMIN')">
		관리자 게시판 목록
		<li><a
			href="${pageContext.request.contextPath}/admin/mouseBoardwrite">글쓰기</a></li>
	</sec:authorize>
</body>
</html>

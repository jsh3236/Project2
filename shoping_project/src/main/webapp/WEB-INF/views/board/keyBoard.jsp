			...
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li class="active"><a href="${pageContext.request.contextPath}/board/keyBoard"><i class="fa fa-angle-right" aria-hidden="true"></i>Keyboard's</a></li>
					</ul>
				</div>
				...
				<div class="sidebar">
					<div class="sidebar_section">
						...
						<ul class="sidebar_categories">
							...
							<li class="active"><a href="${pageContext.request.contextPath}/board/keyBoard"><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>Keyboard</a></li>
